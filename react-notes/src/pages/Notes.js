...
class Notes extends Component {
  ...
  <div className="w-full px-4 mb-4">
    <div className="block w-full bg-gray-800 rounded-lg h-10 outline-none p-2 flex">
      ...
      <input type="text" className="flex-1 outline-none h-full bg-transparent ml-2 font text-gray-300" placeholder="Search" />
    </div>
  </div>
  <div className="px-4 mb-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
    <a href="single-note.html" className="bg-blue-200 p-3 rounded shadow">
      ...
      <p className="text-gray-600 text-sm">San fran was one of the coolest places I have ever been all the beautiful sightseeing and much more...</p>
    </a>
    <a href="single-note.html" className="bg-green-200 p-3 rounded shadow">
      <div className="flex justify-between items-center mb-1">
        <h1 className="font-medium text-lg">Shopping List</h1>
      </div>
      <p className="text-gray-600 text-sm">Okay, so far this is what we need: 12 eggs...</p>
    </a>
  ...
  <a href="new-note.html" className="right-10 bottom-10 z-10 absolute h-14 w-14 rounded-full bg-blue-500 text-white shadow-lg text-xl flex justify-center items-center outline-none focus:outline-none focus:bg-blue-600">
